...
**Última actualización:** 2026-06-09 (mar, 18:30) — **248/980 (25,3%)** — **Lote B sobres +23 pegadas** (22 nuevas + TUN10 re-obtenida de sobre, perdidas 39→38). 🇲🇦 Marruecos estrena (MAR1 escudo foil); 🇵🇹 Portugal 2/20 (POR17 João Félix); estrellas FRA15 Dembélé + ENG10 Rice; brillantes 13→14/68. Pool repetidas 16→21/20. Antes hoy: Lote A +21 (23,0%).
...
| Tengo/pegadas (HAVE) | **248** | registro 2026-06-09 (+23 Lote B sobres) |
| **% completado** (HAVE/N) | **25,3%** | calculado |
| Perdidas (extraviadas en casa) | **38** | lote 06-06 PM (TUN10 re-obtenida), ver `BITACORA_LOTES.md` |
| Faltan (`falta`) | **694** | calculado |
| **Por conseguir** (falta + perdida) | **732** | falta 694 + perdida 38 |
| Repetidas (n°) | **21 cartas / 20 códigos** | registro 2026-06-09 |
