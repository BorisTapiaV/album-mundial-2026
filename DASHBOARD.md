...
| Tengo/pegadas (HAVE) | **667** (595 pegadas + 72 sueltas ⏳ pegar) | registro 2026-06-18 (canje 2 Andrés, −CRO13) |
| **% completado** (HAVE/N) | **68,1%** | calculado |
| Perdidas (extraviadas en casa) | **22** | calculado |
| Faltan (`falta`) | **291** | calculado |
