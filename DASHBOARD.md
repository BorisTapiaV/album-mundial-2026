...
**Última actualización:** 2026-06-21 (dom) PM — **825/980 (84,2%)** 🎉🎉 — **corrección repetidas: AUS17 + POR16 eran copias de slots ya pegados → repetidas 168→170 cartas / 132 códigos (HAVE sin cambio); QR regenerado (825/132) + copiado a Downloads.** — **tres canjes cerrados en un día (+69):** **Paulo V2** (26 recibidas/pegadas) + **Jorge** (24 recibidas/pegadas: 20 nuevas + 4 recuperan perdida COD10/COD11/POR19/KSA10) + **Marcela entrantes** (19 recibidas/pegadas: 16 nuevas + 3 recuperan perdida COD15/KSA6/USA2 + 2 foil FWC8/SUI1). **Catalina** ya estaba en el registro (cierre 19-jun, confirmado). Perdidas 17→**10**. Brillantes 49→**51/68**. **✅ Marcela CERRADA (regalo familia):** 23 salientes reales regaladas (`repetidas −1`; AUT15 fantasma no entró), pool 191→168/130. 🇵🇹 POR15 Cristiano y 🇦🇷 ARG17 Messi siguen faltando (ningún canje los traía). QR regenerado (825) + copiado a Downloads. · *Anterior: 2026-06-20 (sáb) — **756/980 (77,1%)** — **registro sincronizado** (los KPIs de abajo estaban desfasados en 713/70,1%; el registro maestro ya marcaba 756 desde la noche del 19-jun, 69 láminas con fecha 19-jun). Por conseguir: **224** (207 `falta` + 17 `perdida`). Repetidas **191 cartas / 151 códigos**. **Lista de compra a Jorge Vásquez generada** (`JORGE_VASQUEZ_COMPRA_2026-06-20.md`): **179 láminas @ $200 = $35.800**, excluyendo las 45 ya comprometidas con Marcela (19 entrantes) y Paulo V2 (26 compra) — ambos PENDIENTES (registro intacto). 🇵🇹 POR15 Cristiano y 🇦🇷 ARG17 Messi siguen faltando. · *Anterior: 2026-06-19 (vie) PM — **713/980 (72,8%)** (sin cambio de inventario) — **canje Catalina completado en ambas direcciones + lista de faltantes para Jorge Vásquez.** (1) **Verificado: el QR del disco (00:23, post-Paulo) está en sync byte-a-byte con el registro** (713 tengo + 195 códigos repe / 243 cartas). (2) **El doc de Catalina solo tenía la dirección saliente (su wantlist)** — faltaba lo ENTRANTE. Catalina mandó las 14 que ella tiene → **12 le sirven a Boris** (10 `falta` + 2 recuperan `perdida`: CUW4, BRA17; FWC3 es foil ✨): CUW4, HAI12, JPN17, QAT9, BRA17, ALG10, FWC3, CUW8, IRQ13, SWE18, TUN16, TUR7. 2 ya las tenía (UZB10, CRO2). **RESERVADAS como entrantes — Boris AÚN NO las tiene en mano** → NO se compran a terceros, NO se tocan en el registro hasta recibirlas. Al cerrar: HAVE→**725 (74,0%)**, perdidas→19, brillantes→47. (3) **Jorge Vásquez le va a VENDER láminas** (compra, no 1:1) → se generó la lista de faltantes para cruzar **excluyendo las 12 de Catalina**: **236 `falta` + 19 `perdida` = 255 por conseguir** (POR15 Cristiano ⭐ y ARG17 Messi ⭐ entre ellas). 🇵🇹 POR15 sigue faltando. · *Anterior: 2026-06-19 (vie) AM — **713/980 (72,8%)** 🎉 — **canje Paulo Salas CERRADO**: recibidas y pegadas las 26 (`falta/perdida→pegada`). GHA10 Partey recupera perdida (perdidas 22→21). Brillantes 45→46 (FRA1 foil ✨). QR regenerado+copiado a Downloads. 🇵🇹 POR15 Cristiano sigue faltando. · *Anterior: 2026-06-18 (jue) — **687/980 (70,1%)** — **las 92 sueltas PEGADAS** (`tengo→pegada`, HAVE sin cambio; QR Figuritas idéntico porque ambos cuentan como have). 0 sueltas pendientes. · *Antes mismo día — **687/980 (70,1%)** 🎉 cruza el 70% — **+20 láminas nuevas de Andrés** (detectadas decodificando el QR exportado de la app Figuritas): KOR2/9/14, CZE16, BIH7/11/20, MAR9, PAR16, ESP6/7/14/19, URU13, ARG3, AUT7/20, POR4, COD5/9 → todas `falta→tengo` (sueltas ⏳ pegar). **Canje 2 Andrés CERRADO y cuadrado:** recibidas **56 láminas por $9.000 CLP** = 36 de la lista de 37 (sin CRO13) + 20 extra. Boris recontó la pila física y están las 56 completas → el "faltaban 3" fue error de conteo, no había faltantes. Registro exacto, no se revierte nada. CRO13 queda aparte (cambiada) en `falta`. Pool repetidas 245→**243**. Brillantes **45/68**. 🇵🇹 **POR15 Cristiano sigue faltando**. · *Anterior: 2026-06-16 (mar) — **595/980 (60,7%)** 🎉 cruza el 60% — **2 canjes CERRADOS:** **Carlos** (recibió 16: 14 canje + POR6/URU3 extra) + **Andrés Acosta** (das 13 / recibes 15: GER15⭐, FRA5/9/14, URU15, SEN16, NED19, CIV10, KSA16, POR14/18/13 🇵🇹, PAN6, UZB20⭐, ALG3). **31 recibidas SUELTAS** (`falta→tengo`, ⏳ pendiente pegar). POR13+PAN6 eran perdidas → recuperadas (perdidas 25→23). Pool repetidas 209→**196/164** (Andrés -13). 🇵🇹 Portugal +4 hoy (POR6/13/14/18) — **POR15 Cristiano sigue faltando**. Brillantes 40/68. · *Anterior: 14-jun (dom, 21:10) — **564/980 (57,6%)** — **canje recibido de Jorge Vásquez:** +10 nuevas PEGADAS (CUW20, USA14/15/19, ECU8/17, TUR12, ⭐TUR20 Kenan Yıldız, ⭐SCO11 McTominay, HAI15) + 2º CUW7 (pega 1 → repe=1). Pool 222→**223 cartas / 189 códigos**. · *Antes mismo día — **554/980 (56,5%)** — **CROSS-CHECK FÍSICO COMPLETO de la pila de repetidas** (5 paquetes, 223 cartas dictadas) tras detectar repetidas mal registradas al canjear con Jorge Vásquez. **Corrección:** registro inflaba 9 cartas en 8 códigos (USA17, ALG8, EGY10, IRN6, JOR12, BEL10, IRN7, IRN20 — todas con slot **pegado**, no se perdió ningún slot del álbum) + 3 cartas extra en mano (EGY20, HAI16, QAT6) + **CUW7** rescatada (estaba `falta` pero la tenías en la pila → `tengo`, apartada para pegar). Pool **222 cartas / 188 códigos** (= pila física real). Wantlist de Jorge guardada en `JORGE_VASQUEZ_WANTLIST.md` (17 códigos; JOR12+AUT15 ya entregadas). Perdidas 25. Brillantes 39/68. 🇵🇹 Portugal (POR15 Cristiano aún falta). · *Anterior: 14-jun 14:40 lote sobres 553 (+9 pegadas) · 13-jun lote F 544 · 12-jun 392→474.*
...
**Pendientes abiertos:** ✅ **Catalina CERRADA** (cierre 19-jun, confirmado 21-jun). · ✅ **Paulo V2 CERRADO** (26 pegadas 21-jun). · ✅ **Jorge CERRADO entrante** (24 pegadas 21-jun). · ✅ **Marcela CERRADA (regalo familia)** — 19 entrantes pegadas + 23 salientes regaladas (`repetidas −1`). · resolver "scomar" cuando aparezca · precio unitario faltantes tiendapanini.cl (agente cloud 28-jun) · v2 dashboard radar de habilidades. *(Mapeo de especiales `00`/FWC19/inserto ✅ cerrado 14-jun — ver ALBUM_ORDEN.md.)*
...
| Tengo/pegadas (HAVE) | **825** (todas pegadas ✅ — 0 sueltas) | registro 2026-06-21 (Paulo +26, Jorge +24, Marcela +19) |
| **% completado** (HAVE/N) | **84,2%** | calculado |
| Perdidas (extraviadas en casa) | **10** | calculado |
| Faltan (`falta`) | **145** | calculado |
| **Por conseguir** (falta + perdida) | **155** | falta 145 + perdida 10 |
| Repetidas (n°) | **170 cartas / 132 códigos** | registro 2026-06-21 (+2 copias ya pegadas: AUS17, POR16) |
