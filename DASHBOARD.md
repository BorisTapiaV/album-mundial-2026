...
| Tengo/pegadas (HAVE) | **668** (595 pegadas + 73 sueltas ⏳ pegar) | registro 2026-06-17 (canje 2 Andrés) |
| **% completado** (HAVE/N) | **68,2%** | calculado |
| Perdidas (extraviadas en casa) | **22** | calculado |
| Faltan (`falta`) | **290** | calculado |
