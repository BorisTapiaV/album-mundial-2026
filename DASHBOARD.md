...
**Pendientes abiertos:** **🆕 Catalina** — recibir físicamente las 12 entrantes (RESERVADAS, ver `CATALINA_INTERCAMBIO.md`) + entregar las 12 salientes (`repetidas −1`) → al cerrar, registrar ambas direcciones + regenerar QR. · **🆕 Jorge Vásquez** — compra @ $200/lámina. **Lista generada `JORGE_VASQUEZ_COMPRA_2026-06-20.md`: 179 láminas ($35.800)**, excl. las 45 de Marcela+Paulo. Cruzar contra su oferta real y registrar como compra. · **🆕 Marcela Guzmán** — `MARCELA_GUZMAN_INTERCAMBIO.md`: 19 entrantes / 23 salientes, modelo por definir, PENDIENTE. · **🆕 Paulo V2** — `PAULO_SALAS_INTERCAMBIO_V2.md`: compra 26 (~$4.300 ref), PENDIENTE. · resolver "scomar" cuando aparezca · precio unitario faltantes tiendapanini.cl (agente cloud 28-jun) · v2 dashboard radar de habilidades. *(Mapeo de especiales `00`/FWC19/inserto ✅ cerrado 14-jun — ver ALBUM_ORDEN.md.)*
...
| Tengo/pegadas (HAVE) | **756** (todas pegadas ✅ — 0 sueltas) | registro 2026-06-19 PM (sincronizado 2026-06-20) |
| **% completado** (HAVE/N) | **77,1%** | calculado |
| Perdidas (extraviadas en casa) | **17** | calculado |
| Faltan (`falta`) | **207** | calculado |
| **Por conseguir** (falta + perdida) | **224** | falta 207 + perdida 17 |
| Repetidas (n°) | **191 cartas / 151 códigos** | registro 2026-06-19 PM |
